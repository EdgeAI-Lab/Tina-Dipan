...
#define OLED_RST_Clr_R() GPIO_ResetBits(GPIOE,GPIO_Pin_12)  //add by cgy
#define OLED_RST_Set_R() GPIO_SetBits(GPIOE,GPIO_Pin_12)    //接OLED模块CSR

#define OLED_RST_Clr_L() GPIO_ResetBits(GPIOB,GPIO_Pin_12)
#define OLED_RST_Set_L() GPIO_SetBits(GPIOB,GPIO_Pin_12)    //接OLED模块CSL

#define OLED_DC_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_14)
#define OLED_DC_Set() GPIO_SetBits(GPIOB,GPIO_Pin_14)     //接OLED模块D/C

#define OLED_SDA_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_15)
#define OLED_SDA_Set() GPIO_SetBits(GPIOB,GPIO_Pin_15)    //接OLED模块MOSI

#define OLED_SCL_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_13)
#define OLED_SCL_Set() GPIO_SetBits(GPIOB,GPIO_Pin_13)    //接OLED模块的SCLK
